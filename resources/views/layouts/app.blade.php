...
<head>
    ...
    <meta name="author" content="">
     ...
     @yield('extra-meta')
    <!-- Site Icons -->
    <link rel="shortcut icon" href="{{ asset('assetssite/images/favicon.ico') }}" type="image/x-icon" />
    <link rel="apple-touch-icon" href="{{ asset('assetssite/images/apple-touch-icon.png') }}">
    <!-- Bootstrap CSS -->
