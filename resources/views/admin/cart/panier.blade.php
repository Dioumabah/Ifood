                    ...
                    <div class="content-wrapper container">
                        ...
                        @if(Cart::count()>0)
                          <div class="row">
                                         ...
                                         @foreach(Cart::content() as $plat)
                                            ...
                                            <img src="{{ asset('/uploads/plats')}}/{{$restaurant->code_restaurant}}/{{$plat->model->photo}}" width="80" height="80" alt="Apple Cinema 30&quot;" class="img-thumbnail">
                                             ...
                                             {{$plat->model->categories->libelle}}
                                                ...
                                                <td class="text-right">
                                                <a href="/vider-panier/{{$plat->rowId}}" class="btn btn-danger fa fa-trash"></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                            <tr>
                           ...
                           <div class="col-md-4">
                           <form class="form-inline" role="form" method="POST" action="{{route('cart.panier')}}">
                                @csrf
                                <div class="form-group">
                                    <select name="client_id" class="form-control">
                                    @foreach($client as $c)
                                    @if($c->restaurant_id==$restaurant->id)
                                ...
                                <i class="fa fa-cart-plus"></i> Valider la vente
                                </button>
                                </div>
